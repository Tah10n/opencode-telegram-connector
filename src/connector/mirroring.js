...
import { createAgentActionDelivery, formatAgentActionText } from "./mirroring/agent-action-delivery.js"
...
export function createMirroringHandlers(runtime) {
  ...
  const { handleMessagePartUpdated } = createAgentActionDelivery({
    abortSignal,
    isStopping,
    logSseDebug,
