...
- Provisional agent-error notices now remain retryable while their OpenCode message is missing or incomplete; they are cancelled without a tombstone only after a definitive clean completion, so a later confirmed error can still be delivered.
